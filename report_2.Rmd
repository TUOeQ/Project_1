...
Ventilation system in classrooms such that air from the science rooms is not recirculated into non-science areas.

In chemical storage rooms, the ventilation system shall exhaust the air to the outside, and shall not be recirculated back into the space. There is no minimum ventilation rate called out.
...
Refering back to the minimum ventilation rate given by ANSI/ASHRAE 62.1.
...
There yet not clear ventilation stanards listedout for doctor's office but itcould be referred from some of the hospital settings
