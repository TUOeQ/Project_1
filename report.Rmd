...
There are 54,200+ hotel properties in the United States, filling over 5 million guestrooms. There are more than 1.1 billion guests nights annually in the United States, highlighting a constant growing industry trends and increasing investments in guest experiences with spurs community growth. 
...
Opportunity is hardly seen so far in the hotel industry, the data are listed as following:

[![Get more info](./images/hotel2.PNG "Statistics for hotel on demand "){width=95%}](https://www.ahla.com/sites/default/files/State%20Hotel%20Closures%20chart.pdf)

[![Get more info](./images/hotel1.PNG "Statistics for hotel on demand "){width=95%}](https://www.ahla.com/sites/default/files/State%20Hotel%20Closures%20chart.pdf)
...
### Apartment Buildings {.tabset .tabset-pills}
...
[Back to front page](https://tuoeq.github.io/Project_1/Index.html)   