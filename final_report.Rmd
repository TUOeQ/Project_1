...
* The two-way fresh air ventilator (Full heat exchanger). This system is basically perfect in terms of air supply. There is air in and out, to achieve directional airflow while filtering, and heat exchange technology can also reduce indoor air temperature It is a good choice in the fresh air system, but it is not very convenient to use this system in the home. During the heat exchange process, condensation will inevitably occur, breeding molds, and affecting air quality. In addition, the air supply pipes and fans need mindful long-term maintenance. Otherwise, secondary pollution will be more serious in 2-5 years.
